...
**Health Monitoring:**
- Pings 8.8.8.8 and 1.1.1.1 every 5 seconds on both WANs
- Requires 3 consecutive failures to mark WAN as down
- Requires 3 consecutive successes to mark WAN as up
- 2 second timeout per ping

**Routing:**
- wan (eth1) has metric 1 (preferred)
- wan2 (eth2) has metric 2 (backup)
